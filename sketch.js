...
function setup() {
  ...
  trex = createSprite(500,180,20,50);
  trex.visible = false;
  trex.scale = 0.5;
  trex_1 = createSprite(800,180,20,50);
  trex_1.visible = false;
  trex_1.scale = 0.5;
  trex_2 = createSprite(500,380,50,50);
  trex_2.visible = false;
  trex_2.scale = 0.65;
  trex_3 = createSprite(800,380,20,50);
  trex_3.visible = false;
  trex_3.scale = 0.65;


  Start = createSprite(300,575,50,50);
  Start.addImage("trex", Start_Img);
  Start.visible = false;
  Start.scale = 0.65;

  Start1 = createSprite(550,575,50,50);
  Start1.addImage("trex_1", Start1_Img);
  Start1.visible = false;
  Start1.scale = 0.65;

  Start2 = createSprite(800,575,50,50);
  Start2.addImage("trex_2", Start2_Img);
  Start2.visible = false;
  Start2.scale = 0.65;

  Start3 = createSprite(1050,575,50,50);
...
function draw() {
 ...
 ground.debug = true;
  ...
  if(gameState === INTRO){
    text("Welcome to the New and Enhanced T-rex Game!", 400, 40);
    text("Choose your favourite avatar and click on the Start Button which has the colour of your avatar to play!", 150, 80);
